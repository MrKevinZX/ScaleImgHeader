...
import com.bmsr.scaleheaderdemo.banner.listener.OnBannerClickListener;
import com.bmsr.scaleheaderdemo.banner.listener.OnBannerListener;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    public String tag = "baseframework_banner";
    ...
    private int mIndicatorSelectedResId = R.drawable.baseframework_banner_gray_radius;
    private int mIndicatorUnselectedResId = R.drawable.baseframework_banner_white_radius;
    private int mLayoutResId = R.layout.baseframework_banner;
    ...
    public LinearLayout indicator, indicatorInside, titleView;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.baseframework_banner_gray_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.baseframework_banner_white_radius);
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.baseframework_banner_no_banner);
        typedArray.recycle();
    }
    ...
    private void selfLayout(View view, int l, int t, int r, int b) {
        if (view instanceof ViewGroup ) {
            ...
            for (int i = 0; i < ((ViewGroup) view).getChildCount(); i ++) {
                selfLayout(((ViewGroup) view).getChildAt(i), l, t, r, b);
            }
        } else {
            view.layout( l, t, r, b);
            if (view instanceof ImageView) {
                Log.i("wdd", "selfLayout: view " + view.toString() + ", height = " + b);
            }
