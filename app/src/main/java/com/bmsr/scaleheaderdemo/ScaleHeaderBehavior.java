...
public class ScaleHeaderBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    @Override
    public boolean onLayoutChild(@NonNull CoordinatorLayout parent, @NonNull View abl, int layoutDirection) {
    ...
    @Override
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, @NonNull View child, View target, int dx, int dy, int[] consumed, int type) {
        Log.i(TAG, "onNestedPreScroll: child bottom = " + child.getBottom() + ", mAppbarHeight = " + mAppbarHeight);
    ...
    @Override
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, @NonNull View abl, View target, int type) {
        recovery(abl);
